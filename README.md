...
The following figure shows an example application of LinRace on the ZF1-F3 sample (750 cells) from scGESTAULT datasets in (https://doi.org/10.1109/MCI.2018.2840738))](https://doi.org/10.1038/nbt.4103):
